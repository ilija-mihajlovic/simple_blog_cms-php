        ...
        <div>
            ...
            ">
                ...
                <?php if (isset($_SESSION['username'])) : ?>
                    <li>
                        <form action="" method="post"><button type="submit" method name="logout" id="btn" class="loginbtn" style="float: right;">Logout</button></form>
                    </li>
                <?php endif; ?>
    ...
    <div class="posts">
        ...
        <form action="" class="edit" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <textarea name="content" id="txtarea" rows="22" required></textarea>
            </div>
            <div>
            ...
            <div>
                ...
                <button value="Publish Post" name="create_post" type="submit" id="btn" style="float: right; width:105px; padding:0; background-color:#4ECE3D;">
